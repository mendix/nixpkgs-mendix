...
stdenv.mkDerivation {
  name = "mxbuild-7.20.0.41900";
  src = fetchurl {
    url = https://download.mendix.com/runtimes/mxbuild-7.20.0.41900.tar.gz;
    sha256 = "24645fcafb5bf8f49b37d7b7323b35ba3ba3d06452578912ba842ff3047df0aa";
  };
  unpackPhase = ''
    mkdir mxbuild
    cd mxbuild
